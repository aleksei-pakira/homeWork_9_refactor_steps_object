...
def test_registration_form():
    ...
    registration_page.practice_form_user_data('4931031680', 'art', 'Sophienstraße 41, 99817 Eisenach, Germany', 'NCR',
                                              'Delhi')
    ...
    registration_page.should_registered_guest_with(users.guest.full_name, users.guest.user_email, 'Male', '4931031680',
